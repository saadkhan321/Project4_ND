...
## sugar.acid.ratio:ration of sugar content to acid content in the wine sample

wqw$sugar.acid.ratio <- wqw$residual.sugar / wqw$combined.acidity
...
wqw$taste[wqw$sugar.acid.ratio < 1.0] <- 'Dry'
wqw$taste[wqw$sugar.acid.ratio >= 1.0 & wqw$sugar.acid.ratio < 2.1] <- 'Medium_Dry'
wqw$taste[wqw$sugar.acid.ratio >= 2.1 & wqw$sugar.acid.ratio < 4.1] <- 'Medium_Sweet'
wqw$taste[wqw$sugar.acid.ratio >= 4.1] <- 'Sweet'
...
wqr$sugar.acid.ratio <- wqr$residual.sugar / wqr$combined.acidity

## taste: mapping of wine taste to sugar/acid ratio categories (http://drinkriesling.com/wp-content/uploads/2008/11/irf-balance-table-41809-med.jpg)

wqr$taste[wqr$sugar.acid.ratio < 1.0] <- 'Dry'
wqr$taste[wqr$sugar.acid.ratio >= 1.0 & wqr$sugar.acid.ratio < 2.1] <- 'Medium_Dry'
wqr$taste[wqr$sugar.acid.ratio >= 2.1 & wqr$sugar.acid.ratio < 4.1] <- 'Medium_Sweet'
wqr$taste[wqr$sugar.acid.ratio >= 4.1] <- 'Sweet'
...
ggplot() +
  geom_histogram(aes(x=alcohol), data = wqw, alpha = 0.8, color = 'grey', fill = 'white') +
  geom_histogram(aes(x=alcohol), data = wqr, alpha = 0.3, color = 'darkred', fill = 'red')

ggplot() +
  geom_histogram(aes(x=log10(alcohol)), data = wqw, alpha = 0.8, color = 'grey', fill = 'white') +
  geom_histogram(aes(x=log10(alcohol)), data = wqr, alpha = 0.3, color = 'darkred', fill = 'red')
...
ggplot() +
  geom_histogram(aes(x=pH), data = wqw, alpha = 0.8, color = 'grey', fill = 'white') +
  geom_histogram(aes(x=pH), data = wqr, alpha = 0.3, color = 'darkred', fill = 'red')

ggplot() +
  geom_histogram(aes(x=log10(pH)), data = wqw, alpha = 0.8, color = 'grey', fill = 'white') +
  geom_histogram(aes(x=log10(pH)), data = wqr, alpha = 0.3, color = 'darkred', fill = 'red')
...
ggplot() +
  geom_histogram(aes(x=sulphates), data = wqw, alpha = 0.8, color = 'grey', fill = 'white') +
  geom_histogram(aes(x=sulphates), data = wqr, alpha = 0.3, color = 'darkred', fill = 'red')

ggplot() +
  geom_histogram(aes(x=log10(sulphates)), data = wqw, alpha = 0.8, color = 'grey', fill = 'white') +
  geom_histogram(aes(x=log10(sulphates)), data = wqr, alpha = 0.3, color = 'darkred', fill = 'red')
...
ggplot() +
  geom_histogram(aes(x=free.sulfur.dioxide), data = wqw, alpha = 0.8, color = 'grey', fill = 'white') +
  geom_histogram(aes(x=free.sulfur.dioxide), data = wqr, alpha = 0.3, color = 'darkred', fill = 'red')

ggplot() +
  geom_histogram(aes(x=log10(free.sulfur.dioxide)), data = wqw, alpha = 0.8, color = 'grey', fill = 'white') +
  geom_histogram(aes(x=log10(free.sulfur.dioxide)), data = wqr, alpha = 0.3, color = 'darkred', fill = 'red')
...
ggplot() +
  geom_histogram(aes(x=total.sulfur.dioxide), data = wqw, alpha = 0.8, color = 'grey', fill = 'white') +
  geom_histogram(aes(x=total.sulfur.dioxide), data = wqr, alpha = 0.3, color = 'darkred', fill = 'red')

ggplot() +
  geom_histogram(aes(x=log10(total.sulfur.dioxide)), data = wqw, alpha = 0.8, color = 'grey', fill = 'white') +
  geom_histogram(aes(x=log10(total.sulfur.dioxide)), data = wqr, alpha = 0.3, color = 'darkred', fill = 'red')
...
ggplot() +
  geom_histogram(aes(x=combined.acidity), data = wqw, alpha = 0.8, color = 'grey', fill = 'white') +
  geom_histogram(aes(x=combined.acidity), data = wqr, alpha = 0.3, color = 'darkred', fill = 'red')

ggplot() +
  geom_histogram(aes(x=log10(combined.acidity)), data = wqw, alpha = 0.8, color = 'grey', fill = 'white') +
  geom_histogram(aes(x=log10(combined.acidity)), data = wqr, alpha = 0.3, color = 'darkred', fill = 'red')
...
ggplot() +
  geom_histogram(aes(x=residual.sugar), data = wqw, alpha = 0.8, color = 'grey', fill = 'white') +
  geom_histogram(aes(x=residual.sugar), data = wqr, alpha = 0.3, color = 'darkred', fill = 'red')

ggplot() +
  geom_histogram(aes(x=log10(residual.sugar)), data = wqw, alpha = 0.8, color = 'grey', fill = 'white') +
  geom_histogram(aes(x=log10(residual.sugar)), data = wqr, alpha = 0.3, color = 'darkred', fill = 'red')
...
ggplot() +
  geom_histogram(aes(x=residual.sugar), data = wqw, alpha = 0.8, color = 'grey', fill = 'white', binwidth = 0.5) +
  geom_histogram(aes(x=residual.sugar), data = wqr, alpha = 0.3, color = 'darkred', fill = 'red', binwidth = 0.5) +
...
ggplot() +
  geom_histogram(aes(x=sugar.acid.ratio), data = wqw, alpha = 0.8, color = 'grey', fill = 'white') +
  geom_histogram(aes(x=sugar.acid.ratio), data = wqr, alpha = 0.3, color = 'darkred', fill = 'red')

ggplot() +
  geom_histogram(aes(x=log10(sugar.acid.ratio)), data = wqw, alpha = 0.8, color = 'grey', fill = 'white') +
  geom_histogram(aes(x=log10(sugar.acid.ratio)), data = wqr, alpha = 0.3, color = 'darkred', fill = 'red')
...
ggplot() +
  geom_histogram(aes(x=taste), data = wqw, alpha = 0.8, color = 'grey', fill = 'white') +
  geom_histogram(aes(x=taste), data = wqr, alpha = 0.3, color = 'darkred', fill = 'red')
...
ggplot() +
  geom_histogram(aes(x=taste.due.to.pH), data = wqw, alpha = 0.8, color = 'grey', fill = 'white') +
  geom_histogram(aes(x=taste.due.to.pH), data = wqr, alpha = 0.3, color = 'darkred', fill = 'red')
...
ggplot() +
  geom_histogram(aes(x=chlorides), data = wqw, alpha = 0.8, color = 'grey', fill = 'white') +
  geom_histogram(aes(x=chlorides), data = wqr, alpha = 0.3, color = 'darkred', fill = 'red') +
  scale_x_continuous(limits = c(0, 0.5), breaks = seq(0, 0.5, 0.1))

ggplot() +
  geom_histogram(aes(x=log10(chlorides)), data = wqw, alpha = 0.8, color = 'grey', fill = 'white') +
  geom_histogram(aes(x=log10(chlorides)), data = wqr, alpha = 0.3, color = 'darkred', fill = 'red')
...
ggplot() +
  geom_histogram(aes(x=chlorides), data = wqw, alpha = 0.8, color = 'grey', fill = 'white', binwidth = 0.005) +
  geom_histogram(aes(x=chlorides), data = wqr, alpha = 0.3, color = 'darkred', fill = 'red', binwidth = 0.005) +
...
ggplot() +
  geom_histogram(aes(x=density), data = wqw, alpha = 0.8, color = 'grey', fill = 'white') +
  geom_histogram(aes(x=density), data = wqr, alpha = 0.3, color = 'darkred', fill = 'red')
...
ggplot() +
  geom_histogram(aes(x=quality), data = wqw, alpha = 0.8, color = 'grey', fill = 'white') +
  geom_histogram(aes(x=quality), data = wqr, alpha = 0.3, color = 'darkred', fill = 'red') +
...
sub_wqw_cor <- wqw[c("fixed.acidity", "volatile.acidity", "citric.acid", "residual.sugar",
                   "chlorides", "free.sulfur.dioxide" , "total.sulfur.dioxide", "density",
                   "pH", "sulphates", "alcohol", "quality")]

## Tabulating Correlation coefficents rounded to 2 decimel places
...
sub_wqw_ggpairs <- wqw[c("combined.acidity", "residual.sugar", "chlorides", "free.sulfur.dioxide",
                 "total.sulfur.dioxide", "density", "pH", "sulphates", "alcohol", "quality")]

## Plotting sub data frame using ggpairs

ggpairs(sub_wqw_ggpairs, params = c(shape = I('.'), outlier.shape = I('.')), axisLabels = 'internal')
...
sub_wqr_cor <- wqr[c("fixed.acidity", "volatile.acidity", "citric.acid", "residual.sugar",
                   "chlorides", "free.sulfur.dioxide" , "total.sulfur.dioxide", "density",
                   "pH", "sulphates", "alcohol", "quality")]
...
sub_wqr_ggpairs <- wqr[c("combined.acidity", "residual.sugar", "chlorides", "free.sulfur.dioxide",
                 "total.sulfur.dioxide", "density", "pH", "sulphates", "alcohol", "quality")]

## Plotting sub data frame using ggpairs

ggpairs(sub_wqr_ggpairs, params = c(shape = I('.'), outlier.shape = I('.')), axisLabels = 'internal')
...
ggplot() +
  geom_point(aes(x = quality, y = alcohol), data = wqw, size = 3, alpha = 0.1)
...
ggplot(aes(x = as.ordered(quality), y = alcohol), data = wqw) +
  geom_boxplot() + stat_summary(fun.y = mean, geom = 'point', shape =4, color = 'red', size = 3)
...
ggplot() +
  geom_point(aes(x = quality, y = alcohol), data = wqr, size = 3, alpha = 0.1)
...
ggplot() +
  geom_histogram(aes(x=quality, color = taste.due.to.pH, fill = taste.due.to.pH), data = wqw)
...
ggplot() +
  geom_histogram(aes(x=quality, color = taste.due.to.pH, fill = taste.due.to.pH), data = wqr)
...
ggplot() +
  geom_point(aes(x = alcohol, y = pH), data = wqw, size = 3, alpha = 0.1)
...
ggplot() +
  geom_point(aes(x = alcohol, y = pH), data = wqr, size = 3, alpha = 0.1)
...
ggplot() +
  geom_freqpoly(aes(x=alcohol, color = taste.due.to.pH), data = wqw, size = 1.5)
...
ggplot() +
  geom_freqpoly(aes(x=alcohol, color = taste.due.to.pH), data = wqr, size = 1.5)
...
ggplot() +
  geom_point(aes(x = quality, y = sulphates), data = wqw, size = 3, alpha = 0.1)
...
ggplot() +
  geom_point(aes(x = quality, y = sulphates), data = wqr, size = 3, alpha = 0.1)
...
ggplot() +
  geom_point(aes(x = quality, y = pH), data = wqw, size = 3, alpha = 0.1)
...
ggplot() +
  geom_histogram(aes(x=citric.acid), data = wqr, alpha = 0.3, color = 'darkred', fill = 'red')
...
ggplot() +
  geom_point(aes(x = quality, y = citric.acid), data = wqr, size = 3, alpha = 0.1)
...
ggplot() +
  geom_point(aes(x = density, y = residual.sugar), data = wqw, alpha = 0.1, size = 3)
...
```{r echo=FALSE, Bivariate_Plots_scatter_density_residual_sugar_Red}

ggplot() +
  geom_point(aes(x = density, y = residual.sugar), data = wqr, alpha = 0.1, size = 3)
...
```{r echo=FALSE, cor_coeff_density_residual_sugar_Red}

cor.test(wqr$density,wqr$residual.sugar)
...
ggplot() +
  geom_histogram(aes(x=fixed.acidity), data = wqw, alpha = 0.8, color = 'grey', fill = 'white') +
  geom_histogram(aes(x=fixed.acidity), data = wqr, alpha = 0.3, color = 'darkred', fill = 'red')

```

**Scatter Plot for White wine (Density vs. Fixed Acidity)**

```{r echo=FALSE, Bivariate_Plots_scatter_density_fixed_acidity_White}

ggplot() +
  geom_point(aes(x = density, y = fixed.acidity), data = wqw, alpha = 0.1, size = 3)
...
```{r echo=FALSE, cor_coeff_density_fixed_acidity_White}

cor.test(wqw$density,wqw$fixed.acidity)
...
ggplot() +
  geom_point(aes(x = density, y = fixed.acidity), data = wqr, alpha = 0.1, size = 3)
...
```{r echo=FALSE, Bivariate_Plots_Sugar_Acid_Ratio_SO2_White}
...
```{r echo=FALSE, Bivariate_Plots_scatter_Sugar_Acid_Ratio_SO2_White}

ggplot() +
  geom_point(aes(x = sugar.acid.ratio, y = total.sulfur.dioxide), data = wqw, size = 3, alpha = 0.1)

```

**Correlation coefficient for White wine (Sugar to Acid Ratio vs. Total Sulphur Dioxide)**

```{r echo=FALSE, cor_coeff_Sugar_Acid_Ratio_SO2_white}

cor.test(wqw$sugar.acid.ratio,wqw$total.sulfur.dioxide)
...
```{r echo=FALSE, Bivariate_Plots_Density_Combined_Acidiy_Red}
...
```{r echo=FALSE, Bivariate_Plot_Density_Combined_Acidiy_Red}

ggplot() +
  geom_point(aes(x = density, y = combined.acidity), data = wqr, size = 3, alpha = 0.1)

```

**Correlation coefficient for Red wine (Density vs. Combined Acidity)**

```{r echo=FALSE, cor_coeff_Density_Combined_Acidiy_red}

cor.test(wqr$density,wqr$combined.acidity)
...
```{r echo=FALSE, Bivariate_Plot_Residual_Sugar_Combined_Acidiy_White}

ggplot() +
  geom_point(aes(x = combined.acidity, y = residual.sugar), data = wqw, size = 3, alpha = 0.1)

```

**Correlation coefficient for White wine (Residual Sugar vs. Combined Acidity)**

```{r echo=FALSE, cor_coeff_Residual_Sugar_Combined_Acidiy_white}

cor.test(wqw$residual.sugar,wqw$combined.acidity)
...
```{r echo=FALSE, Bivariate_Plot_Residual_Sugar_Combined_Acidiy_Red}

ggplot() +
  geom_point(aes(x = combined.acidity, y = residual.sugar), data = wqr, size = 3, alpha = 0.1)

```

**Correlation coefficient for Red wine (Residual Sugar vs. Combined Acidity)**

```{r echo=FALSE, cor_coeff_Residual_Sugar_Combined_Acidiy_red}

cor.test(wqr$residual.sugar,wqr$combined.acidity)
...
```{r echo=FALSE, Bivariate_Plot_Sulphates_Chlorides_White}

ggplot() +
  geom_point(aes(x = sulphates, y = chlorides), data = wqw, size = 3, alpha = 0.1)

```

**Correlation coefficient for White wine (Density vs. Combined Acidity)**

```{r echo=FALSE, cor_coeff_Sulphates_Chlorides_white}

cor.test(wqw$sulphates,wqw$chlorides)
...
```{r echo=FALSE, Bivariate_Plot_Sulphates_Chlorides_Red}

ggplot() +
  geom_point(aes(x = sulphates, y = chlorides), data = wqr, size = 3, alpha = 0.1)

```

**Correlation coefficient for Red wine (Sulphates vs. Chlorides)**

```{r echo=FALSE, cor_coeff_Sulphates_Chlorides_red}

cor.test(wqr$sulphates,wqr$chlorides)
...
```{r echo=FALSE, cor_coeff_Total_SO2_Free_SO2_white}

cor.test(wqw$total.sulfur.dioxide,wqw$free.sulfur.dioxide)

```

**Correlation coefficient for White wine (Total SO2 vs. Free SO2)**

```{r echo=FALSE, cor_coeff_Total_SO2_Free_SO2_red}

cor.test(wqr$total.sulfur.dioxide,wqr$free.sulfur.dioxide)
...
ggplot() +
  geom_density(aes(x=alcohol, color = as.ordered(quality)), data = wqw, size = 1)
...
ggplot() +
  geom_density(aes(x=alcohol, color = as.ordered(quality)), data = wqr, size = 1)
...
```{r echo=FALSE, Multivariate_Plots_scatter_quality_alcohol_with_taste_White}

ggplot() +
  geom_point(aes(x = quality, y = alcohol, color = taste), data = wqw, alpha = 0.8, position = 'jitter')
...
```{r echo=FALSE, Multivariate_Plots_scatter_quality_alcohol_with_taste_zoom_White}

ggplot(aes(x = quality, y = alcohol, color = taste), data = wqw) +
...
```{r echo=FALSE, Multivariate_Plots_scatter_quality_alcohol_with_taste_pH_zoom_White}

ggplot(aes(x = quality, y = alcohol, color = taste.due.to.pH), data = wqw) +
  geom_point(alpha = 0.8, position = 'jitter') +
  xlim(4.5,7.5) +
  ylim(8,14)
...
```{r echo=FALSE, Multivariate_Plots_scatter_quality_alcohol_with_taste_Red}

ggplot() +
  geom_point(aes(x = quality, y = alcohol, color = taste), data = wqr, alpha = 0.8, position = 'jitter')
...
```{r echo=FALSE, Multivariate_Plots_scatter_quality_alcohol_with_taste_pH_zoom_Red}

ggplot(aes(x = quality, y = alcohol, color = taste.due.to.pH), data = wqr) +
  geom_point(alpha = 0.8, position = 'jitter') +
  xlim(4.5,7.5) +
  ylim(8,14)
...
ggplot() +
  geom_point(aes(x = alcohol, y = pH, color = as.ordered(quality)), data = subset(wqw, quality < 8 & quality > 4), alpha = 0.8,position = 'jitter')
...
ggplot() +
  geom_point(aes(x = alcohol, y = pH, color = as.ordered(quality)), data = subset(wqr, quality < 8 & quality > 4), alpha = 0.8,position = 'jitter')
...
ggplot() +
  geom_density(aes(x=sulphates, color = as.ordered(quality)), data = wqw, size = 1)
...
ggplot() +
  geom_density(aes(x=sulphates, color = as.ordered(quality)), data = wqr, size = 1)
...
ggplot() +
  geom_point(aes(x = alcohol, y = sulphates, color = as.ordered(quality)),
             data = subset(wqw, quality < 8 & quality > 4), alpha = 0.8, position = 'jitter') +
  ylim(0.35,0.65)
...
ggplot() +
  geom_density(aes(x=residual.sugar, color = as.ordered(quality)), data = wqw, size = 1)
...
ggplot() +
  geom_density(aes(x=residual.sugar, color = as.ordered(quality)), data = wqr, size = 1)
...
ggplot() +
  geom_point(aes(x = alcohol, y = residual.sugar, color = as.ordered(quality)), data = wqw, alpha = 0.2,position = 'jitter')
...
ggplot() +
  geom_point(aes(x = alcohol, y = residual.sugar, color = as.ordered(quality)), data = wqr,position = 'jitter') +
  ylim(0,4)
...
acid_density_1 <- ggplot() +
  geom_density(aes(x=fixed.acidity, color = as.ordered(quality)), data = wqw, size = 1)

acid_density_2 <- ggplot() +
  geom_density(aes(x=volatile.acidity, color = as.ordered(quality)), data = wqw, size = 1)

acid_density_3 <- ggplot() +
  geom_density(aes(x=citric.acid, color = as.ordered(quality)), data = wqw, size = 1)

acid_density_4 <- ggplot() +
  geom_density(aes(x=fixed.acidity, color = as.ordered(quality)), data = wqr, size = 1)

acid_density_5 <- ggplot() +
  geom_density(aes(x=volatile.acidity, color = as.ordered(quality)), data = wqr, size = 1)

acid_density_6 <- ggplot() +
  geom_density(aes(x=citric.acid, color = as.ordered(quality)), data = wqr, size = 1)
...
acid_multi_2 <- ggplot() +
  geom_point(aes(x = alcohol, y = volatile.acidity, color = as.ordered(quality)),
             data = wqw, position = 'jitter', alpha = 0.5, size=0.8)
...
ggplot() +
  geom_density(aes(x=chlorides, color = as.ordered(quality)), data = wqw, size = 1)
...
ggplot() +
  geom_density(aes(x=chlorides, color = as.ordered(quality)), data = wqr, size = 1)
...
ggplot() +
  geom_point(aes(x = alcohol, y = chlorides, color = type), data = combined_wq,
             alpha = 0.8, position = 'jitter', alpha = 0.1, pch=5) + facet_wrap(~quality)
...
SO2_density_1 <- ggplot() +
  geom_density(aes(x=total.sulfur.dioxide, color = as.ordered(quality)), data = wqw, size = 1)

SO2_density_2 <- ggplot() +
  geom_density(aes(x=free.sulfur.dioxide, color = as.ordered(quality)), data = wqw, size = 1)

SO2_density_3 <- ggplot() +
  geom_density(aes(x=total.sulfur.dioxide, color = as.ordered(quality)), data = wqr, size = 1)

SO2_density_4 <- ggplot() +
  geom_density(aes(x=free.sulfur.dioxide, color = as.ordered(quality)), data = wqr, size = 1)
...
SO2_multi_1 <- ggplot() +
  geom_point(aes(x = alcohol, y = total.sulfur.dioxide, color = as.ordered(quality)),
             data = wqw, position = 'jitter', alpha = 0.5, size=0.8)
  
SO2_multi_2 <- ggplot() +
  geom_point(aes(x = alcohol, y = free.sulfur.dioxide, color = as.ordered(quality)),
             data = wqw, position = 'jitter', alpha = 0.5, size=0.8)
...
ggplot() +
  geom_density(aes(x=density, color = as.ordered(quality)), data = wqw, size = 1)
...
ggplot() +
  geom_density(aes(x=density, color = as.ordered(quality)), data = wqr, size = 1)
...
ggplot() +
  geom_point(aes(x = alcohol, y = density, color = type), data = combined_wq,
             alpha = 0.8, position = 'jitter', alpha = 0.1) + facet_wrap(~quality)

```

##### Again, facet wrapping was used to idenify trends in different quality buckets. In general, there does not seem to be any trends between denisty and quality with introduction of alcohol.
...
ggplot() +
  geom_point(aes(x = residual.sugar, y = density, color = as.ordered(quality)),
             data = wqw, position = 'jitter', alpha = 0.5, pch=1) +
  geom_abline(slope=0.0005, intercept=0.9905)
...
ggplot() +
  geom_point(aes(x = fixed.acidity, y = density, color = as.ordered(quality)),
             data = wqr, position = 'jitter', alpha = 0.5, pch=1) +
  geom_abline(slope=0.0008, intercept=0.9895)
...
##sub_wq_cor <- combined_wq[c("fixed.acidity", "volatile.acidity", "citric.acid", "residual.sugar",                   "chlorides", "free.sulfur.dioxide" , "total.sulfur.dioxide", "density", "pH", "sulphates", "alcohol", "quality", "sugar.acid.ratio", "combined.acidity")]

## Tabulating Correlation coefficents rounded to 2 decimel places

##round(cor(sub_wq_cor), 2)
...
m13 <- update(m12, ~ . + sugar.acid.ratio)
...
ggplot() +
  geom_freqpoly(aes(x=alcohol, color = type), data = combined_wq, size = 1.5, binwidth = 0.2) +
  ...
  scale_colour_manual(name="Wine Type", values=c("white","red")) +
  theme(legend.position=c(0.95, 0.95), legend.justification = c(1, 1)) + scale_shape_discrete(name="") +
...
ggplot(aes(x = as.ordered(quality), y = alcohol, fill = as.ordered(quality)), data = wqr) +
  theme(panel.background = element_blank()) +
  geom_boxplot() + stat_summary(fun.y = mean, geom = 'point', shape = 4, color = 'red', size = 3) +
  scale_y_continuous(breaks = seq(8, 15, 1)) +
  xlab('Quality rating of Red Wine Samples') +
  ylab('Alcohol content of Red Wine Samples (%)') +
  ggtitle("Alcohol vs. Quality for Red Wine") +
  theme(plot.title = element_text(face="bold", color='darkblue')) +
  theme(axis.text = element_text(face="bold", colour = "black")) +
  theme(axis.title.x = element_text(face="bold", color='black'),
        axis.title.y = element_text(face="bold", color='black')) +
  scale_fill_manual(name="Quality", values=c("#E78AC3","#A6D854","#E5C494","#66C2A5","#FC8D62","#8DA0CB")) +
  theme(legend.position=c(0.2, 0.95), legend.justification = c(1, 1)) + scale_shape_discrete(name="") +
...
ggplot() +
  ...
  scale_y_continuous(breaks = seq(0.5, 2.0, 0.25)) +
  xlab('Alcohol content of Red Wine Samples (%)') +
  ylab('Sulphate content of Red Wine Samples (g/dm^3)') +
  ggtitle("Sulphates vs. Alcohol with Quality for Red Wine") +
  theme(plot.title = element_text(face="bold", color='darkblue')) +
  theme(axis.text = element_text(colour = "black")) +
  theme(axis.title.x = element_text(face="bold", color='black'),
        axis.title.y = element_text(face="bold", color='black')) +
  scale_color_manual(name="Quality", values=c("red","orange","yellow","lightgreen","green","darkgreen")) +
  theme(legend.position=c(0.95, 0.95), legend.justification = c(1, 1)) + scale_shape_discrete(name="") +
  theme(legend.key=element_rect(fill="white"))
